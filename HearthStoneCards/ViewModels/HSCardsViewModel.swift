        ...
        dataService.$hsCardsModelData
            .sink { [weak self] (receivedHSCardModel) in
                self?.standardCardSetDATA = receivedHSCardModel
                    .compactMap({ $0 })
                    .filter({ self!.standardCardSetNamesYear2021.contains($0.set ?? "") && $0.name != "???" && $0.type != "HERO_POWER" })
                self?.wildCardSetNamesYear2021DATA = receivedHSCardModel
                    .compactMap({ $0 })
                    .filter({ self!.wildCardSetNamesYear2021.contains($0.set ?? "") && $0.name != "???" && $0.type != "HERO_POWER" })
                self?.theBarrensCardSetDATA = receivedHSCardModel
                    .compactMap({ $0 })
                    .filter({ $0.set == "THE_BARRENS" && $0.name != "???" && $0.type != "HERO_POWER" })
                self?.darkmoonFaireCardSetDATA = receivedHSCardModel
                    .compactMap({ $0 })
                    .filter({ $0.set == "DARKMOON_FAIRE" && $0.name != "???" && $0.type != "HERO_POWER" })
                self?.scholomanceCardSetDATA = receivedHSCardModel
                    .compactMap({ $0 })
                    .filter({ $0.set == "SCHOLOMANCE" && $0.name != "???" && $0.type != "HERO_POWER" })// HERO_POWER
                self?.blackTempleCardSetDATA = receivedHSCardModel
                    .compactMap({ $0 })
                    .filter({ $0.set == "BLACK_TEMPLE" && $0.name != "???" && $0.type != "HERO_POWER" })
                self?.coreCardSetDATA = receivedHSCardModel
                    .compactMap({ $0 })
                    .filter({ $0.set == "CORE" && $0.name != "???" && $0.type != "HERO_POWER" })
                self?.demonHunterInitiateCardSetDATA = receivedHSCardModel
                    .compactMap({ $0 })
                    .filter({ $0.set == "DEMON_HUNTER_INITIATE" && $0.name != "???" && $0.type != "HERO_POWER" })
                self?.naxxCardSetDATA = receivedHSCardModel
                    .compactMap({ $0 })
                    .filter({ $0.set == "NAXX" && $0.name != "???" && $0.type != "HERO_POWER" })
                self?.gvgCardSetDATA = receivedHSCardModel
                    .compactMap({ $0 })
                    .filter({ $0.set == "GVG" && $0.name != "???" && $0.type != "HERO_POWER" })
                self?.brmCardSetDATA = receivedHSCardModel
                    .compactMap({ $0 })
                    .filter({ $0.set == "BRM" && $0.name != "???" && $0.type != "HERO_POWER" })
                self?.tgtCardSetDATA = receivedHSCardModel//
                    .compactMap({ $0 })
                    .filter({ $0.set == "TGT" && $0.name != "???" && $0.type != "HERO_POWER" })
                self?.loeCardSetDATA = receivedHSCardModel
                    .compactMap({ $0 })
                    .filter({ $0.set == "LOE" && $0.name != "???" && $0.type != "HERO_POWER" })
                self?.ogCardSetDATA = receivedHSCardModel
                    .compactMap({ $0 })
                    .filter({ $0.set == "OG" && $0.name != "???" && $0.type != "HERO_POWER" })
                self?.karaCardSetDATA = receivedHSCardModel
                    .compactMap({ $0 })
                    .filter({ $0.set == "KARA" && $0.name != "???" && $0.type != "HERO_POWER" })
                self?.gangsCardSetDATA = receivedHSCardModel
                    .compactMap({ $0 })
                    .filter({ $0.set == "GANGS" && $0.name != "???" && $0.type != "HERO_POWER" })
                self?.ungoroCardSetDATA = receivedHSCardModel
                    .compactMap({ $0 })
                    .filter({ $0.set == "UNGORO" && $0.name != "???" && $0.type != "HERO_POWER" })
                self?.iceCrownCardSetDATA = receivedHSCardModel
                    .compactMap({ $0 })
                    .filter({ $0.set == "ICECROWN" && $0.name != "???" && $0.type != "HERO_POWER" })
                self?.lootApaloozaCardSetDATA = receivedHSCardModel
                    .compactMap({ $0 })
                    .filter({ $0.set == "LOOTAPALOOZA" && $0.name != "???" && $0.type != "HERO_POWER" })
                self?.gilneasCardSetDATA = receivedHSCardModel
                    .compactMap({ $0 })
                    .filter({ $0.set == "GILNEAS" && $0.name != "???" && $0.type != "HERO_POWER" })
                self?.boomsdayCardSetDATA = receivedHSCardModel
                    .compactMap({ $0 })
                    .filter({ $0.set == "BOOMSDAY" && $0.name != "???" && $0.type != "HERO_POWER" })
                self?.trollCardSetDATA = receivedHSCardModel
                    .compactMap({ $0 })
                    .filter({ $0.set == "TROLL" && $0.name != "???" && $0.type != "HERO_POWER" })
                self?.dalaranCardSetDATA = receivedHSCardModel//
                    .compactMap({ $0 })
                    .filter({ $0.set == "DALARAN" && $0.name != "???" && $0.type != "HERO_POWER" })
                self?.uldumCardSetDATA = receivedHSCardModel
                    .compactMap({ $0 })
                    .filter({ $0.set == "ULDUM" && $0.name != "???" && $0.type != "HERO_POWER" })
                self?.dragonsCardSetDATA = receivedHSCardModel
                    .compactMap({ $0 })
                    .filter({ $0.set == "DRAGONS" && $0.name != "???" && $0.type != "HERO_POWER" })
                self?.yearOfTheDragonCardSetDATA = receivedHSCardModel
                    .compactMap({ $0 })
                    .filter({ $0.set == "YEAR_OF_THE_DRAGON" && $0.name != "???" && $0.type != "HERO_POWER" })
                self?.legacyCardSetDATA = receivedHSCardModel
                    .compactMap({ $0 })
                    .filter({ $0.set == "LEGACY" && $0.name != "???" && $0.type != "HERO_POWER" })
