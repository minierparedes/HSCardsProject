//
//  RastakhanRumbleCardsView.swift
//  HearthStoneCards
//
...
struct RastakhanRumbleCardsView: View {
    @StateObject var hsCardsVM: HSCardsViewModel = HSCardsViewModel()
    var dictionaryGroup: [String: [HSCardModel]] {
        Dictionary(grouping: hsCardsVM.trollCardSetDATA, by: { $0.cardClass ?? "N/A" })
    }
    var uniq: [String] {
...
struct RastakhanRumbleCardsView_Previews: PreviewProvider {
