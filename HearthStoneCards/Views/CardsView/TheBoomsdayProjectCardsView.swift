//
//  TheBoomsdayProjectCardsView.swift
//  HearthStoneCards
//
...
struct TheBoomsdayProjectCardsView: View {
    @StateObject var hsCardsVM: HSCardsViewModel = HSCardsViewModel()
    var dictionaryGroup: [String: [HSCardModel]] {
        Dictionary(grouping: hsCardsVM.boomsdayCardSetDATA, by: { $0.cardClass ?? "N/A" })
    }
    var uniq: [String] {
...
struct TheBoomsdayProjectCardsView_Previews: PreviewProvider {
