//
//  DescentOfDragonsCardsView.swift
//  HearthStoneCards
//
...
struct DescentOfDragonsCardsView: View {
    @StateObject var hsCardsVM: HSCardsViewModel = HSCardsViewModel()
    var dictionaryGroup: [String: [HSCardModel]] {
        Dictionary(grouping: hsCardsVM.dragonsCardSetDATA, by: { $0.cardClass ?? "N/A" })
    }
    var uniq: [String] {
...
struct DescentOfDragonsCardsView_Previews: PreviewProvider {
