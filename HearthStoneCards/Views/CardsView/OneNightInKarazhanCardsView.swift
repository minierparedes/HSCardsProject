//
//  OneNightInKarazhanCardsView.swift
//  HearthStoneCards
//
...
struct OneNightInKarazhanCardsView: View {
    @StateObject var hsCardsVM: HSCardsViewModel = HSCardsViewModel()
    var dictionaryGroup: [String: [HSCardModel]] {
        Dictionary(grouping: hsCardsVM.karaCardSetDATA, by: { $0.cardClass ?? "N/A" })
    }
    var uniq: [String] {
...
struct OneNightInKarazhanCardsView_Previews: PreviewProvider {
