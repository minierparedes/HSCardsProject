//
//  JourneyToUnGoroCardsView.swift
//  HearthStoneCards
//
...
struct JourneyToUnGoroCardsView: View {
    @StateObject var hsCardsVM: HSCardsViewModel = HSCardsViewModel()
    var dictionaryGroup: [String: [HSCardModel]] {
        Dictionary(grouping: hsCardsVM.ungoroCardSetDATA, by: { $0.cardClass ?? "N/A" })
    }
    var uniq: [String] {
...
struct JourneyToUnGoroCardsView_Previews: PreviewProvider {
