//
//  DemonHunterInitiateCardsView.swift
//  HearthStoneCards
//
...
struct DemonHunterInitiateCardsView: View {
    @StateObject var hsCardsVM: HSCardsViewModel = HSCardsViewModel()
    var dictionaryGroup: [String: [HSCardModel]] {
        Dictionary(grouping: hsCardsVM.demonHunterInitiateCardSetDATA, by: { $0.cardClass ?? "N/A" })
    }
    var uniq: [String] {
...
struct DemonHunterInitiateCardsView_Previews: PreviewProvider {
