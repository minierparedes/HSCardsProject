//
//  TheLeagueOfExplorersCardsView.swift
//  HearthStoneCards
//
...
struct TheLeagueOfExplorersCardsView: View {
    @StateObject var hsCardsVM: HSCardsViewModel = HSCardsViewModel()
    var dictionaryGroup: [String: [HSCardModel]] {
        Dictionary(grouping: hsCardsVM.loeCardSetDATA, by: { $0.cardClass ?? "N/A" })
    }
    var uniq: [String] {
...
struct TheLeagueOfExplorersCardsView_Previews: PreviewProvider {
