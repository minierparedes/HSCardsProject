...
struct GoblinsGnomesCardsView: View {
    @StateObject var hsCardsVM: HSCardsViewModel = HSCardsViewModel()
    var dictionaryGroup: [String: [HSCardModel]] {
        Dictionary(grouping: hsCardsVM.gvgCardSetDATA, by: { $0.cardClass ?? "N/A" })
    }
    var uniq: [String] {
...
struct GoblinsGnomesCardsView_Previews: PreviewProvider {
