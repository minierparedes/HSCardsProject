//
//  GalakrondAwakeningCardsView.swift
//  HearthStoneCards
//
...
struct GalakrondAwakeningCardsView: View {
    @StateObject var hsCardsVM: HSCardsViewModel = HSCardsViewModel()
    var dictionaryGroup: [String: [HSCardModel]] {
        Dictionary(grouping: hsCardsVM.yearOfTheDragonCardSetDATA, by: { $0.cardClass ?? "N/A" })
    }
    var uniq: [String] {
...
struct GalakrondAwakeningCardsView_Previews: PreviewProvider {
