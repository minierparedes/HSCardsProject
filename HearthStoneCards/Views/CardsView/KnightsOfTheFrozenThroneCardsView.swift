//
//  KnightsOfTheFrozenThroneCardsView.swift
//  HearthStoneCards
//
...
struct KnightsOfTheFrozenThroneCardsView: View {
    @StateObject var hsCardsVM: HSCardsViewModel = HSCardsViewModel()
    var dictionaryGroup: [String: [HSCardModel]] {
        Dictionary(grouping: hsCardsVM.iceCrownCardSetDATA, by: { $0.cardClass ?? "N/A" })
    }
    var uniq: [String] {
...
struct KnightsOfTheFrozenThroneCardsView_Previews: PreviewProvider {
