//
//  BlackrockMoutainCardsView.swift
//  HearthStoneCards
//
...
struct BlackrockMoutainCardsView: View {
    @StateObject var hsCardsVM: HSCardsViewModel = HSCardsViewModel()
    var dictionaryGroup: [String: [HSCardModel]] {
        Dictionary(grouping: hsCardsVM.brmCardSetDATA, by: { $0.cardClass ?? "N/A" })
    }
    var uniq: [String] {
...
struct BlackrockMoutainCardsView_Previews: PreviewProvider {
