//
//  KoboldsCatacombsCardsView.swift
//  HearthStoneCards
//
...
struct KoboldsCatacombsCardsView: View {
    @StateObject var hsCardsVM: HSCardsViewModel = HSCardsViewModel()
    var dictionaryGroup: [String: [HSCardModel]] {
        Dictionary(grouping: hsCardsVM.lootApaloozaCardSetDATA, by: { $0.cardClass ?? "N/A" })
    }
    var uniq: [String] {
...
struct KoboldsCatacombsCardsView_Previews: PreviewProvider {
