//
//  MeanStreetsOfGadgetzanCardsView.swift
//  HearthStoneCards
//
...
struct MeanStreetsOfGadgetzanCardsView: View {
    @StateObject var hsCardsVM: HSCardsViewModel = HSCardsViewModel()
    var dictionaryGroup: [String: [HSCardModel]] {
        Dictionary(grouping: hsCardsVM.gangsCardSetDATA, by: { $0.cardClass ?? "N/A" })
    }
    var uniq: [String] {
...
struct MeanStreetsOfGadgetzanCardsView_Previews: PreviewProvider {
