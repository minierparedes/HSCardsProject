...
struct FlipCardCellView: View {
    let cardModel: HSCardModel
    var body: some View {
        VStack {
            FlipCardImageView(url: cardModel.cardImageURL, cardBack: (HSCardModel.CardBackIMG(rawValue: cardModel.set!) ?? HSCardModel.CardBackIMG(rawValue: "classic"))!, key: cardModel.id)
